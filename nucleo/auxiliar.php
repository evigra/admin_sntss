...
//ini_set("smtp_port", "25");            
			...
			*/
			{	
				...
				$boSend =  @mail("evigra@gmail.com", $option["title"], $message, $headers,"-fNoReply<noreply@sntss-xxv.com>");
					    ...
					    {			
						    ...
						    if(isset($this->sys_fields[$campo]["values"]) AND isset($this->sys_fields[$campo]["values"][0]))
						    {
						        ...
						        {						            
						            ...
						            $words[$campo."._medium"]     ="<img src=\"$path_pdf\">";
						            $words[$campo."._big"]        ="<img src=\"$path_pdf\">";
